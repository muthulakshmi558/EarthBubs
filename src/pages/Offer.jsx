  ...
  return (
    ...
    <section className="max-w-7xl mx-auto px-4 py-10 font-[Poppins]">
      ...
      <div className="text-sm font-bold text-black-400 mb-6">
        Home &gt; Products &gt; <span className="font-semibold">Offer</span>
      </div>
...
<div className="relative">
  ...
  <button className="absolute font-bold top-0 right-2 bg-[#00B4D8] text-black px-4 py-1 rounded-full shadow-lg hover:bg-[#009bbd] transition">
    Buy
  </button>
</div>
